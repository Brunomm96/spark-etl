...
class ProductionUnitTypeDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_production_unit_type'
    ...
    @classmethod
    def extractProductionUnitTypeDD(self):
        df = KafkaServer()
...
df_stg = ProductionUnitTypeDD.extractProductionUnitTypeDD()
