...
class TechnicalSheetDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_technical_sheet'
    ...
    @classmethod
    def extractTechnicalSheetDD(self):
        df = KafkaServer()
...
df_stg = TechnicalSheetDD.extractTechnicalSheetDD()
