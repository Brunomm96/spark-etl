...
class EmployeePositionDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_employee_position'
    ...
    @classmethod
    def extractEmployeePositionDD(self):
        df = KafkaServer()
...
df_stg = EmployeePositionDD.extractEmployeePositionDD()
