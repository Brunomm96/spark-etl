...
class HelpChainHierarchyLevelDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_help_chain_hierarchy_level'
    ...
    SCHEMA = StructType([
        ...
        StructField("order_level", IntegerType()),
    ...
    @classmethod
    def extractHelpChainHierarchyLevelDD(self):
        df = KafkaServer()
...
df_stg = HelpChainHierarchyLevelDD.extractHelpChainHierarchyLevelDD()
