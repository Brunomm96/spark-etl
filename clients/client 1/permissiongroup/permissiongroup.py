...
class PermissionGroupDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_permission_group'
    ...
    @classmethod
    def extractPermissionGroupDD(self):
        df = KafkaServer()
...
df_stg = PermissionGroupDD.extractPermissionGroupDD()
