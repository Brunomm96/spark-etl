...
class ActionConfigTelegramDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_action_config_telegram'
    ...
    SCHEMA = StructType([
        ...
        StructField("message_default", StringType()),
    ...
    @classmethod
    def extractActionConfigTelegramDD(self):
        df = KafkaServer()
...
df_stg = ActionConfigTelegramDD.extractActionConfigTelegramDD()
