...
class TechnicalSheetKeyDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_technical_sheet_key'
    ...
    @classmethod
    def extractTechnicalSheetKeyDD(self):
        df = KafkaServer()
...
df_stg = TechnicalSheetKeyDD.extractTechnicalSheetKeyDD()
