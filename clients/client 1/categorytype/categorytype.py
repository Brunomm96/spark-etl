...
class CategoryTypeDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_category_type'
    ...
    @classmethod
    def extractCategoryTypeDD(self):
        df = KafkaServer()
...
df_stg = CategoryTypeDD.extractCategoryTypeDD()
