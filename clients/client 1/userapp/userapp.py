...
class UserAppDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_user_app'
    ...
    SCHEMA = StructType([
        ...
        StructField("first_access", IntegerType()),
        StructField("password_expires_in", StringType()),
...
df_stg = UserAppDD.extractUserAppDD()
