...
class AttributeBackupDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_attribute_backup'
    ...
    @classmethod
    def extractAttributeBackupDD(self):
        df = KafkaServer()
...
df_stg = AttributeBackupDD.extractAttributeBackupDD()
