...
class CategoryDD:
    TOPIC = 'Client2_Debezium_.datadriven_Client2.dbo.dw_category'
    ...
    SCHEMA = StructType([
        ...
        StructField("category_type_id", LongType()),
        StructField("oee", IntegerType()),
...
df_stg = CategoryDD.extractCategoryDD()
