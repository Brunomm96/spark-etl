...
class UploadsCsvTemplateLogDD:
    TOPIC = 'Client2_Debezium.datadriven_Client2.dbo.dw_uploads_csv_template_log'
        
    SCHEMA = StructType([
        StructField("before", StringType()),
        StructField("after", StringType()),
        StructField("id", LongType()),
        StructField("uploads_csv_template_id", LongType()),
        StructField("line_file", LongType()),
        StructField("content_line", StringType()),
        StructField("message_line", StringType()),
    ...
    @classmethod
    def extractUploadsCsvTemplateLogDD(self):
        df = KafkaServer()
...
df_stg = UploadsCsvTemplateLogDD.extractUploadsCsvTemplateLogDD()
